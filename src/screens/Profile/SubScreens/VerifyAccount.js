  ...
  return loading ? (
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.containerForm}>
        ...
        />
        {errors.name && (
          <Text style={{color: 'red'}}>Ingrese un nombre válido.</Text>
        )}
        <Controller
          control={control}
          render={({onChange, onBlur, value}) => (
        ...
        />
        {errors.last_name && (
          <Text style={{color: 'red'}}>Ingrese un apellido válido.</Text>
        )}
        <Controller
          control={control}
          render={({onChange, onBlur, value}) => (
        ...
        />
        {errors.email && (
          <Text style={{color: 'red'}}>Ingrese un correo válido.</Text>
        )}
        <Controller
          control={control}
          render={({onChange, onBlur, value}) => (
        ...
        <Text
          ...
          Indicanos tu profesion o que actividad realizas
        </Text>
        <Controller
          control={control}
          render={({onChange, onBlur, value}) => (
